export default {
    ...
    mainMenu: {
      ...
      equalOpp: 'Ogeechee Technical College es una institución de igualdad de oportunidades',
    ...
    carousel: {
      ...
      venuesSub: "¡El lugar perfecto para su próximo evento social o de negocios!",
      oakText: 'El Oak Room',
      oakSub: 'Grandes ventanales iluminan este espacio finamente decorado.',
      riverText: 'El River Room',
      riverSub: 'El River Room es cómodo y funcional para seminarios de capacitación, conferencias y presentaciones.',
      ...
      kennedybSub: 'El Kennedy Boardroom ofrece el mejor escenario para su próxima reunión de negocios.',
      ogeecheeText: 'El Ogeechee Boardroom',
      ogeecheeSub: 'El Ogeechee Boardroom tiene capacidad para 16 personas alrededor de una mesa de conferencias de estilo ejecutivo.',
      kennedyaText: 'El Kennedy Auditorium',
      kennedyaSub: 'Desde sesiones de capacitación hasta oradores de renombre este auditorio recientemente renovado ofrece una experiencia brillante en el lugar.',
      computerText: 'Laboratorios de Computación',
      computerSub: 'Nuestros laboratorios de computadoras pueden acomodar hasta 25 personas.',
      classroomText: 'Aulas',
      classroomSub: 'Ofrecemos una amplia gama de aulas con capacidad para 15 a 40 participantes.',
    ...
    cards: {
      ...
      //The Oak Room
      oakText: "Ofrezca a sus invitados el ambiente de un evento al aire libre con todas las comodidades de un moderno salón interior. Las grandes ventanas iluminan el espacio finamente decorado, ofreciendo un panorama de exuberantes bosques y vegetación que crea un entorno realmente impresionante. Desde bodas y eventos sociales hasta ferias y conferencias, The Oak Room transformará su reunión y creará recuerdos inolvidables.",
      oakEnhancedPackageOne: '• 10 horas contiguas los sábados (entre las 8:00 a.m. y las 12:00 a.m.)',
      oakEnhancedPackageTwo: '• 6 horas contiguas el jueves o viernes anterior solo para configuración (entre las 9:00 a.m. y las 6:00 p.m.',
      ...
      oakFeeIncludesSix: '• Acceso a la cocina para la entrega y puesta en escena de catering',
      ...
      //Ogeechee Boardroom
      ogeecheeText: "La sala de juntas Ogeechee, ubicada en el Edificio de Estudios Ocupacionales, tiene capacidad para 16 personas alrededor de una mesa de conferencias de estilo ejecutivo con capacidad para 10-15 personas adicionales alrededor del perímetro de la sala. Elegantemente decorada, esta sala de juntas cuenta con muebles finos, alfombras de pared a pared, una pantalla de proyección de 65 pulgadas, conectividad inalámbrica a Internet y capacidad de llamadas en conferencia. También hay una sala privada adyacente donde se pueden servir refrescos.",
      ...
      //Computer Labs
      computerText: "Nuestros laboratorios de computadoras de alta tecnología están equipados con los sistemas Dell Optiplex 3020 y pueden acomodar hasta 25 personas. Cada computadora cuenta con el sistema operativo Windows 7 y Microsoft Office 2016. Cada laboratorio cuenta con una estación de computadora de enseñanza dedicada con capacidades de proyección incorporadas, pizarras de borrado en seco y conectividad inalámbrica a Internet.",
      ...
      //Classrooms
      classroomsText: "Ofrecemos una amplia gama de aulas con capacidad para 15 a 40 participantes. Todas nuestras aulas están equipadas con tecnología de audio / visual de sistema inteligente de última generación. Cada sala cuenta con una estación de computadora de enseñanza dedicada con capacidades de proyección incorporadas, pizarras de borrado en seco y conectividad inalámbrica a Internet.",
      ...
      //The Atrium
      atriumText: "Al entrar en este espacio de dos pisos del Edificio de Recursos Naturales, los huéspedes son recibidos con ventanas de patio a piso, chimenea de piedra y columnas, y una gran escalera. Tanto de día como de noche, el Atrium es perfecto para recepciones y exhibiciones de estilo, tanto de día como de noche. Ya sea solo o combinado con Oak Room, ¡El Atrium es simplemente hermoso!",
